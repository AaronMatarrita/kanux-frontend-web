  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to(wave5Ref.current, {
        attr: {
          d: "M0,320L60,313.3C120,307,240,293,360,293.3C480,293,600,307,720,309.3C840,311,960,301,1080,298.7C1200,296,1320,304,1380,309.3L1440,314L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z",
        },
        duration: 12,
        repeat: -1,
        yoyo: true,
