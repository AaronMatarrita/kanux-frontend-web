...
const OPTIONS: OptionAccountSelection[] = [
  {
    ...
    title: "Professional",
    description:
      "Build skills, complete challenges, and get discovered by companies.",
  ...
  },
  {
    ...
    title: "Company",
    description:
      "Create challenges, analyze talent, and connect with skilled candidates.",
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        ...
        <h2 className="text-2xl font-semibold mt-6 text-[#0B2A4A]">
          Choose your account type
        </h2>
        <p className="text-sm text-slate-500 mt-2">
          Select how you want to use Kánux
        </p>
      </div>
      ...
      <div
        className={cn(
          "max-w-6xl mx-auto px-4 mt-6",
          selectedKey ? "block" : "hidden",
        )}
      >
        <button
          ...
          className={cn(
            "w-full py-3 rounded-lg text-white font-medium transition-opacity duration-150",
