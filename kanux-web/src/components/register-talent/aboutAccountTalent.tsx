  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validate()) {
      ...
      try {
        ...
        const response = await profilesService.preRegisterProfile(
          user,
          createProfile,
        );
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-center text-muted-foreground">
          Esto ayuda a las empresas a entender tu experiencia y habilidades.
        </p>
      </div>
      {serverError && (
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          <h2 className="text-sm font-bold text-foreground uppercase tracking-wide mb-6">
